...
Tests:
Passed:1. Your regex should use two positive lookaheads.
...
Tests:
Failed:1. Your regex myRegex should return true for the string Franklin D. Roosevelt
Failed:2. Your regex myRegex should return true for the string Eleanor Roosevelt
...
Failed:8. Your result should return true.
...
Tests:
Failed:1. Your regex should use the shorthand character class for digits.
Failed:2. Your regex should reuse a capture group twice.
Failed:3. Your regex should match the string 42 42 42.
Failed:4. Your regex should match the string 100 100 100.
...
Failed:9. Your regex should match the string 10 10 10.
...
Tests:
Waiting:1. You should use .replace() to search and replace.
Waiting:2. Your regex should change the string one two three to the string three two one
Waiting:3. You should not change the last line.
Waiting:4. fixRegex should use at least three capture groups.
Waiting:5. replaceText should use parenthesized submatch string(s) (i.e. the nth parenthesized submatch string, $n, corresponds to the nth capture group).
...
Tests:
Waiting:1. result should be equal to the string Hello, World!
Waiting:2. Your solution should not use the String.prototype.trim() method.
Waiting:3. The result variable should not directly be set to a string
Waiting:4. The value of the hello variable should not be changed.
